...
- (void)setupView
{
    ...
    // NavigationBar
    UINavigationBar *navbar = [[UINavigationBar alloc]initWithFrame:CGRectMake(0.0f, 0.0f, self.view.frame.size.width, KNavBarHeight)];
    ...
    UIBarButtonItem *callButton = [[UIBarButtonItem alloc] initWithTitle:@"Voice" style:UIBarButtonItemStylePlain target:self action:@selector(voice)];
    
    [item setLeftBarButtonItem:backButton];
    [item setRightBarButtonItem:callButton];
	...
	// Table View
    CGRect tableFrame = CGRectMake(0.0f, KNavBarHeight, self.view.frame.size.width, self.view.frame.size.height - kInputHeight - KNavBarHeight);
